...
- **플럭스**(flux; 대사 통량), **반응**(reaction), **대사물**(metabolite)은 각각 단위 생물량·단위 시간당 반응 진행률(mmol·gDW$$^{-1}$$·h$$^{-1}$$), 화학량론적 변환, 구획을 포함한 화학종을 뜻한다. 플럭스는 절대적인 물질의 양이 아니라 속도(rate)이다.
...
오믹스 자료는 대사 플럭스를 직접 대체하지 않는다. 이 장에서는 자료마다 GEM에 주는 정보의 층위가 다르다는 점을 먼저 구분한다.
