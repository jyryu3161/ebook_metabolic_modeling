...
- $$\mathbf{S}$$의 행과 열은 구조 진단에 쓰인다. 전부 0인 행은 어떤 반응에도 참여하지 않는 고립 대사물이고, 방향까지 고려해 생성만 또는 소비만 되는 대사물은 막다른(dead-end) 대사물이어서 그에 연결된 반응을 blocked reaction으로 만든다. 교환·demand·sink·biomass 반응 열은 비영 원소가 균형을 이루지 않는 의도적 unbalanced 경계 반응이며, 질량·전하 균형은 내부 반응에만 요구된다.
