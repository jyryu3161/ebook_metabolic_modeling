...
*그림 2.2. Reaction record에서 구분되는 유전자·단백질·반응·대사물의 관계. GPR은 촉매 가능성을 나타내는 Boolean 관계이며 enzyme abundance나 kinetic rate를 직접 나타내지 않는다. 자발 반응과 의사반응에는 효소 연결이 없을 수 있다. 저자 작성.*
