...
Reaction $$j$$의 [flux](../glossary.md) $$v_j$$는 저장된 stoichiometric direction에 대한 순반응 속도이다. 이 교재의 [COBRApy](https://opencobra.github.io/cobrapy/) 예제에서는 단위가 $$\mathrm{mmol\,gDW^{-1}\,h^{-1}}$$이다.
