...
- **[플럭스](../glossary.md)**(flux; 대사 통량), **반응**(reaction), **대사물**(metabolite)은 각각 단위 시간·단위 생물량당 반응 진행률, 화학량론적 변환, 구획을 포함한 화학종을 뜻한다.
...
| $$\mathbf v\in\mathbb R^n$$ | [flux vector](../glossary.md) |
