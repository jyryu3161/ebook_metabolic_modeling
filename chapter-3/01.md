...
*Table 3.1. 모델 릴리스별 보고 규모. 수치는 서로 다른 집계 기준을 사용하므로 단순한 생물학적 복잡도 순위로 해석하지 않는다. 출처: [iML1515, DOI 10.1038/nbt.3956](https://doi.org/10.1038/nbt.3956); [Recon3D, DOI 10.1038/nbt.4072](https://doi.org/10.1038/nbt.4072); [Human1, DOI 10.1126/scisignal.aaz1482](https://doi.org/10.1126/scisignal.aaz1482).*
...
*Table 3.2. `e_coli_core`의 모델 구조 통계. 계산 조건: COBRApy 0.30.0, `load_model("textbook")`. 단순 $$n/G$$와 실제 gene-reaction incidence 지표가 서로 다른 질문에 답함을 보여준다. 모델 artifact·loader·parser가 바뀌면 재집계한다.*
