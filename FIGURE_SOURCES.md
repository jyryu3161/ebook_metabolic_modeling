...
이 문서는 출판 원고가 직접 참조하는 raster 자산, 그에 대응하는 SVG 원본, 그리고 Chapter 1·2–4·5·6·8–10의 주요 Mermaid 도식을 추적합니다. 자산·링크·권리 문구의 최종 검증일은 **2026-07-10**이며, Chapter 6 항목은 **2026-07-22**에 추가·검증했습니다. Chapter 7에는 Mermaid 도식이 없어 해당 절을 두지 않았습니다.
...
| L-06 | [`.gitbook/assets/lab11/fig_cmm_eflux_lad.png`](.gitbook/assets/lab11/fig_cmm_eflux_lad.png) | [`chapter-11/06.md`](chapter-11/06.md) 그림 11.7 | CMM E-Flux2 vs LAD 예측 flux 산점도; 합성 발현, 배지 `glucose_aerobic` | CMM 0.3.0, BiGG `e_coli_core` | 저자 계산·시각화 | 2026-07-11 |
| L-07 | [`.gitbook/assets/lab11/cmm_gui.png`](.gitbook/assets/lab11/cmm_gui.png) | [`chapter-11/06.md`](chapter-11/06.md) 그림 11.8 | CMM 데스크톱 GUI 시뮬레이션 화면 | 저자 도구 [CMM](https://github.com/jyryu3161/CMM)(MIT) 저장소 이미지 | 저자 도구 GUI 자작 스크린샷 | 2026-07-11 |
| L-08 | [`.gitbook/assets/lab11/fig_cmig_community.png`](.gitbook/assets/lab11/fig_cmig_community.png) | [`chapter-11/07.md`](chapter-11/07.md) 그림 11.9 | CMIG 3-구성원 군집의 구성원 성장률과 교환 프로파일 | CMIG 0.1.0, MICOM 0.39.0, 합성 fixture | 저자 계산·시각화 | 2026-07-11 |
| L-09 | [`.gitbook/assets/lab11/fig_cmig_dfba.png`](.gitbook/assets/lab11/fig_cmig_dfba.png) | [`chapter-11/07.md`](chapter-11/07.md) 그림 11.10 | CMIG 동적 FBA 시간경과(바이오매스·포도당); t≈5.36 고갈 | CMIG 0.1.0, Gurobi, dt=0.1 | 저자 계산·시각화 | 2026-07-11 |
| L-10 | [`.gitbook/assets/lab11/fig_cmig_spatial.png`](.gitbook/assets/lab11/fig_cmig_spatial.png) | [`chapter-11/07.md`](chapter-11/07.md) 그림 11.11 | CMIG 2D 공간 미리보기 포도당 확산 히트맵 | CMIG 0.1.0 spatial-preview | 저자 계산·시각화 | 2026-07-11 |
...
| 1.7 | [`chapter-1/05.md`](chapter-1/05.md) | 모델 기술의 네 기준 | 저자 교육용 taxonomy; 특정 외부 그림 없음. 개념 근거로 [Orth et al. (2010)](https://doi.org/10.1038/nbt.1614)의 제약 기반 정식화와 [Thiele & Palsson (2010)](https://doi.org/10.1038/nprot.2009.203)의 재구축–모델 구분만 인용. | 2026-07-22 |
| 1.8 | [`chapter-1/07.md`](chapter-1/07.md) | 연구 대상별 응용과 검증 | 저자 교육용 종합; 원 논문 그림 재사용 없음. 개념 근거로 [Burgard et al. (2003)](https://doi.org/10.1002/bit.10803), [Robinson et al. (2020)](https://doi.org/10.1126/scisignal.aaz1482), [Heinken et al. (2023)](https://doi.org/10.1038/s41587-022-01628-0)의 응용 사실만 인용. | 2026-07-22 |
...
| 2.3 | [`chapter-2/03.md`](chapter-2/03.md) | 대사 네트워크의 행렬·이분 그래프·투영 표현 | [Samal and Martin (2011)](https://doi.org/10.1371/journal.pone.0022295)의 이분 그래프·대사물 투영 구분 개념만 인용. | 2026-07-22 |
...
아래 도식은 각 Markdown의 Mermaid source가 원본인 저자 자체 제작물이다. 두 도식 모두 개념 모식도이며 모델 계산 결과가 아니다. 외부 논문의 그림·패널·레이아웃을 복제하거나 변형하지 않았고, 개념 근거 문헌은 절차·방법 사실만 인용했다. 개별 논문의 그림 재사용 라이선스는 본 원고가 외부 그림을 포함하지 않으므로 별도로 확인하지 않았다.

| 그림 | Mermaid 원본 위치 | 대상 | 개념 원출처와 권리 처리 | 검증일 |
|:---:|:---|:---|:---|:---:|
| 6.1 | [`chapter-6/01.md`](chapter-6/01.md) | 오믹스 증거에서 맥락 특이적 모델과 검증으로 이어지는 정보 흐름 | [Opdam et al. (2017)](https://doi.org/10.1016/j.cels.2017.01.010), [Richelle et al. (2019)](https://doi.org/10.1371/journal.pcbi.1006867)의 추출·검증 절차를 사실로 인용하고 독립 흐름도 제작. 원 그림 재사용 없음. | 2026-07-22 |
| 6.2 | [`chapter-6/06.md`](chapter-6/06.md) | 다중 오믹스를 맥락 특이적 제약 모델로 통합하는 프레임워크 | tINIT([Agren et al., 2014](https://doi.org/10.1002/msb.145122)), GIM3E([Schmidt et al., 2013](https://doi.org/10.1093/bioinformatics/btt493)), ME-model([Lloyd et al., 2018](https://doi.org/10.1371/journal.pcbi.1006302)), GECKO([Sánchez et al., 2017](https://doi.org/10.15252/msb.20167411))의 방법 사실을 종합해 독립 도식 제작. 원 그림 재사용 없음. | 2026-07-22 |
