...
손으로 LP 행을 검산해 봅시다. 아래 코드의 LP는 $$x\ge0,\,y\ge0,\,x+y\le6,\,2x+y\le8$$이라는 다각형 안에서 $$3x+2y$$를 최대화합니다. 다각형의 꼭짓점 중 하나인 $$(2,4)$$를 대입하면 $$3\times2+2\times4=6+8=14$$로, 아래 코드에서 `solid` 실선으로 표시한 $$3x+2y=14$$ 등고선과 정확히 만납니다 — 실제로 LP의 최적해는 항상 다각형의 "꼭짓점"에서 나타난다는 [Chapter 4](../chapter-4/)의 심플렉스법 원리를 이 작은 예제로 다시 확인할 수 있습니다.
