...
| [선형 계획법](../glossary.md) | Linear Programming (LP) | 선형 목적 함수를 선형 제약 하에서 최적화하는 수학적 기법 |
...
| [그림자 가격](../glossary.md) | Shadow Price | 물질수지 제약이 완화될 때 목적 함수값이 변하는 정도, $$\partial Z^*/\partial b_i$$ |
...
| [대안 최적해](../glossary.md) | Alternate Optima | 동일한 최적 목적 함수값을 갖는 서로 다른 플럭스 분포 |
