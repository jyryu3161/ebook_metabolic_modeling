...
> [Chapter 7의 질병 표적 탐색](../chapter-7..md)에 들어가기 전에 읽는 선행 페이지입니다. 유전자 결손을 반응 제약으로 바꾸는 법, FBA·MOMA·ROOM이 서로 다른 질문에 답한다는 점, COBRApy 결과를 올바르게 읽는 법을 정리합니다.
...
두 단일 결손은 생존하지만 이중 결손이 치명적이면 합성 치사입니다. 이는 [Chapter 7](../chapter-7..md)의 선택적 암 표적과 [Chapter 8](../chapter-8..md)의 균주 설계에서 모두 사용됩니다.
