...
Demand와 sink는 편리하지만 모델의 결함을 숨길 수 있습니다. 특히 sink를 열어 둔 채 성장이나 표적 생산을 분석하면 존재하지 않는 경로가 물질을 공급할 수 있습니다. [Chapter 5의 gap-filling과 QC](../chapter-5..md)에서 이를 다시 점검합니다.
...
ATPM의 하한이 NGAM이며, 바이오매스 반응에 포함된 ATP 가수분해 계수가 GAM입니다. 기질 흡수율과 성장률 관계를 현실적으로 재현하려면 둘을 구분해야 합니다. 자세한 생물학적 해석은 [Chapter 3 §6](../chapter-3.-genome-scale-metabolic-model-gem.md)을 참고하십시오.
...
이 주석 품질은 [MEMOTE](../chapter-5..md)의 annotation 점수와 모델 병합 성공률에 직접 영향을 줍니다.
...
- SBML 안에 들어가는 GPR·구획·경계·바이오매스: [Chapter 3](../chapter-3.-genome-scale-metabolic-model-gem.md)
- SBML을 만들고 MEMOTE로 검증하는 재구축 과정: [Chapter 5](../chapter-5..md)
- 목적함수·bound가 실제 계산에 미치는 영향: [Chapter 4](../chapter-4.-flux-balance-analysis-fba.md)
