...
*표 5.8. Human1 논문판의 대표 통계. 출처: [Robinson et al. (2020)](https://doi.org/10.1126/scisignal.aaz1482), CC BY 4.0.*
...
*표 5.9. Human1 논문이 동일 분석에서 보고한 비교. Recon3D의 별도 model판은 이미 stoichiometrically consistent하므로 이 행렬의 Recon3D reconstruction과 혼동하지 않는다. 출처: [Robinson et al. (2020)](https://doi.org/10.1126/scisignal.aaz1482).*
...
*표 5.10. 서로 다른 시점의 대표 규모. 출처: [Human1](https://doi.org/10.1126/scisignal.aaz1482), [Human2 논문](https://doi.org/10.1073/pnas.2516511123), [Human-GEM v2.0.0 release](https://github.com/SysBioChalmers/Human-GEM/releases/tag/v2.0.0). 모델 규모의 감소 자체는 품질 개선 또는 저하를 증명하지 않는다.*
