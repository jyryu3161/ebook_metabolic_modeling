...
서열이 비슷하다는 것은 두 단백질이 공통 조상에서 갈라졌다는 증거이지, 같은 촉매 기능을 가진다는 직접 증거는 아니다. 특히 paralog(유전자 중복으로 생긴 사본)의 기능 분화, 다중 도메인 단백질, 효소의 기질 promiscuity(한 효소가 여러 기질에 작용하는 성질), 복합체 subunit 누락이 자동 기능 전이의 주요 오류 원인이 된다.
