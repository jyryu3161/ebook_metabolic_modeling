...
*Table 5.5. gap-filling 알고리즘은 서로 다른 ‘갭’을 목표로 한다. 출처: [Reed et al. (2006)](https://doi.org/10.1186/1471-2105-7-417), [Satish Kumar et al. (2007)](https://doi.org/10.1186/1471-2105-8-212), [Kumar & Maranas (2009)](https://doi.org/10.1371/journal.pcbi.1000308), [Thiele et al. (2014)](https://doi.org/10.1093/bioinformatics/btu321).*
...
*그림 5.6. 학습 기반 점수와 제약 기반 gap-filling의 역할 분리. 저자 작성 모식도(모델 계산 결과 아님); 개념 근거: [Chen, Liao & Liu (2023)](https://doi.org/10.1038/s41467-023-38110-7)의 CHESHIRE 후보 순위화를 일반화했으며, 원 논문 그림을 복제하지 않았다.*
