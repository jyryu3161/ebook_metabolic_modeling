...
| Recon2M (2017) | 1,106 genes에 대한 11,415 GeTPRA | gene–transcript–protein–reaction association 확장 |
...
- 전체 **reconstruction**인지 계산에 사용한 flux-consistent **model**인지?
...
지속적으로 갱신되는 Human-GEM은 release별 Zenodo archive를 제공한다. 분석 결과를 작성할 때 최신 main branch가 아니라 실제 사용한 immutable release를 인용한다.
