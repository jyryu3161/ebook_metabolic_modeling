...
*표 5.4. 출판 당시 도구와 데이터 release를 사용한 통합 벤치마크. 효소 활성, 에너지원, 발효 생성물, 유전자 필수성 및 혐기성 먹이망 자료를 pooled하여 계산했으므로 특정 생물종이나 단일 endpoint의 보편 성능으로 해석하지 않는다. 출처: [Zimmermann et al. (2021)](https://doi.org/10.1186/s13059-021-02295-1), CC BY 4.0.*
