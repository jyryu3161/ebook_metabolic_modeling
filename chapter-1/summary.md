...
- [제약 기반 모델](../glossary.md)은 가능한 정상상태 집합을, [동역학 모델](../glossary.md)은 속도식과 초기조건 아래의 시간 궤적을 분석한다. [ecGEM](../glossary.md), ME-model, 오믹스 통합과 [dynamic FBA](../glossary.md)는 서로 다른 정보를 추가하는 방법이며 하나의 우열 순서가 아니다.
