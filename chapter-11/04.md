...
MOMA는 결손 직후의 세포가 야생형 flux 분포에서 **최소한으로만 벗어난다**고 가정하고, 야생형과의 거리를 최소화하는 flux를 찾습니다. 원형 MOMA는 유클리드 거리(2차 목적함수, QP)를 최소화하고, 선형 MOMA는 절댓값 합(LP)을 최소화합니다([Chapter 8](../chapter-8/README.md), [핵심 방법 보충](../supplements/perturbation-analysis.md)).
