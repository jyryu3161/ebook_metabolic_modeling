...
*그림 11.4. PGI 결손 후 각 반응 flux를 야생형 pFBA flux(가로축)에 대해 그린 산점도. 대각선은 “야생형과 동일”을 뜻합니다. 대부분의 점이 대각선 근처에 있어, PGI 결손이 이 조건에서 비교적 완만한 재배선을 유발함을 보여 줍니다. QP MOMA는 그림에 표시하지 않았으나 성장률은 세 방법 중 가장 낮습니다. 저자 계산·시각화; COBRApy 0.30.0, GLPK/Gurobi.*
