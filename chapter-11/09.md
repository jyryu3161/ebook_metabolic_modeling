...
각 구성원이 아세테이트·CO$$_2$$를 분비하는 것은 종간 [cross-feeding](../chapter-8/README.md)의 물질적 토대입니다. 한 구성원의 분비물이 다른 구성원의 기질이 되는 관계는 엣지 표(secretion/uptake)로 추적합니다.
...
포도당이 0에 가까워지면 FBA가 infeasible이 되는데, 이는 오류가 아니라 "더는 성장할 자원이 없다"는 회분식 배양의 자연스러운 종료입니다.
