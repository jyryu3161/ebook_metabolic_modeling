...
**mmplatform**은 발현 데이터를 이용해 시료 특이적(sample-specific) 대사 모델을 만들고, 그 모델에서 유전자 교란의 영향을 평가하는 워크플로입니다([github.com/jyryu3161/mmplatform](https://github.com/jyryu3161/mmplatform)). 이 절에서는 먼저 수정한 TROPPO 기반 tINIT으로 맥락 특이적 모델을 만듭니다. 다음으로 LAD로 발현 정보를 반영한 플럭스 대리값을 맞추고, 선형 MOMA로 유전자 교란을 평가합니다([Chapter 5](../chapter-5/README.md), [Chapter 6](../chapter-6/README.md), [Chapter 7](../chapter-7/README.md)).
