# 6. mmplatform: tINIT 맥락특이적 재구축

**mmplatform**은 발현 데이터로 시료 특이적(sample-specific) 대사 모델을 재구축하고, 발현-정보 flux 대리값을 적합한 뒤 유전자 교란을 평가하는 설정 기반 워크플로입니다([github.com/jyryu3161/mmplatform](https://github.com/jyryu3161/mmplatform)). 맥락특이적 재구축에는 **수정 TROPPO 기반 tINIT 통합**을, flux 적합에는 LAD를, 교란 평가에는 선형 MOMA를 사용합니다([Chapter 5](../chapter-5/README.md), [Chapter 6](../chapter-6/README.md), [Chapter 7](../chapter-7/README.md)).
