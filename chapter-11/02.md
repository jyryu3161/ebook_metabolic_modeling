...
*그림 11.2. `e_coli_core`의 FBA 최적해에서의 주요 교환 flux(GLPK, 기본 배지, 바이오매스 최대화). 음수(붉은색)는 흡수, 양수(파란색)는 분비입니다. 포도당 10, 산소 21.8을 흡수해 이산화탄소 22.8과 물 29.2를 분비하며, 아세테이트·에탄올·포름산 분비는 0입니다. 즉 호기적 포도당 조건에서 탄소가 완전히 산화되는 상태입니다. 저자 계산·시각화; COBRApy 0.30.0, GLPK.*
