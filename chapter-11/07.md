...
*표 11.2. TRACE-GEM task 결과의 일부(전체 52개). 모두 통과하므로 gap-filling이 반응을 추가하지 않습니다.*
...
*그림 11.8. TRACE-GEM 그래픽 인터페이스. iML1515 모델과 52개 대사 task의 통과/실패 결과를 함께 표시합니다. 출처: TRACE-GEM GUI, [github.com/jyryu3161/TRACE-GEM](https://github.com/jyryu3161/TRACE-GEM).*
